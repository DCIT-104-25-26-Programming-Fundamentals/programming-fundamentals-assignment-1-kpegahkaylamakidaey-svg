...
def get_grade(score):
    ...
    # Simple if/elif statements to pick the grade letter
    if score >= 80:
        return "A"
    elif score >= 70:
        return "B"
...
def main():
    ...
    grade_result = get_grade(score_value)
    
    # If the function returned None, print the exact error message requested
